---
description: The Finscale Ava-Chain is an instance of the Avalanche Virtual Machine (AVM).
---
...
}' -H 'content-type:application/json;' https://api.avax-test.network:443/ext/bc/X/wallet
```
